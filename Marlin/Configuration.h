...
#define STRING_CONFIG_H_AUTHOR "Jason H" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Kossel Mini Magnetic"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "550d1a9d-148f-4f33-9708-4ca066919bd9"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // 12V MK2Y 200
  #define  DEFAULT_bedKp 362.988
  #define  DEFAULT_bedKi 52.75988372093023
  #define  DEFAULT_bedKd 624.3393599999999
...
// :[-1,1]
#define X_HOME_DIR 1 //Delta Printers Home to Max, Always
#define Y_HOME_DIR 1
#define Z_HOME_DIR 1
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
  //#define MESH_HOME_SEARCH_Z 5 // Z After Home. Somewhere below MANUAL_Z_HOME_POS but above 0,0
...
#define HOMING_FEEDRATE_Z  (600*10)
